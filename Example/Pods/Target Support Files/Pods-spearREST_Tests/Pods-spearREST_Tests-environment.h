...
// spearREST
#define COCOAPODS_POD_AVAILABLE_spearREST
#define COCOAPODS_VERSION_MAJOR_spearREST 0
#define COCOAPODS_VERSION_MINOR_spearREST 1
#define COCOAPODS_VERSION_PATCH_spearREST 0
